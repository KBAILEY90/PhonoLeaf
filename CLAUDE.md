...
- **Native shell (Stage 2a, added 2026-07-06):** Capacitor 8 wraps the SAME
  ...
  limited to arm, and the voice model (currently `vits-piper-en_US-libritts_r-medium`;
  the plugin auto-detects Kokoro vs Piper from the files) is owner-placed in
  `app/src/main/assets/kokoro/` (folder name kept regardless of model;
  gitignored — TESTING.md §3.6).
