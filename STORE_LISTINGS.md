...
> **Offline note: DEVICE-VERIFIED 2026-08-10.** `BACKLOG.md` section C is fully
> implemented — cached Drive file list for offline library browsing, cached
...
> copy before ever calling Drive. Owner confirmed on a real Android device
> that download + offline mode both work. **The offline claim is safe to
> publish in both listings.**
